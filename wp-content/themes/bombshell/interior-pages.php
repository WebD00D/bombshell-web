...
<div id="index-banner" class=" black" style="margin-top:0px;height:40vh;background:url(<?php echo $img_thumb_url; ?>);background-size:cover;background-position:center">
